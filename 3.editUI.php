...
if ($id <=0) {
	...
	$sql = "select jobName, jobUrgent, jobContent, jobState from todo where id=?;"; 
...
<input type="button" onClick="updateForm1()" value="送出" />
